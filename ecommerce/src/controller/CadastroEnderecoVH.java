...
public class CadastroEnderecoVH implements IViewHelper { 
	...
	public EntidadeDominio getEntidade(HttpServletRequest request, HttpServletResponse response) {
		...
		Endereco endereco = new Endereco(cliente, request.getParameter("descricaoEndereco"), TipoLogradouro.valueOf(request.getParameter("tipoLogradouro")),
				...
				cidade, request.getParameter("observacaoEndereco"), TipoEndereco.valueOf(request.getParameter("tipoEndereco")));
