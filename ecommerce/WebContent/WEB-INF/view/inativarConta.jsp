					...
					<div class="card-body">
						<div class="row">
							...
							<p>Ao inativar sua conta, você não receberá mais e-mails de ofertas e novidades.</p>
								...
								<br/>
								<div>
									<a href="/ecommerce/controlador?acao=ListaClientes" class="btn btn-secondary w-25" alt="Cancelar inativação" title="Cancelar inativação" type="submit">
										<i class="far fa-smile-beam"></i>
									</a>	
									<a href="/ecommerce/controlador?acao=Logout" class="btn white border w-25" type="submit" alt="Confirmar inativação" title="Confirmar inativação">
