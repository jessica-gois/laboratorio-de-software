		...
		<div class="cabecalho-ecomm mb-3 p-3 d-flex justify-content-between shadow">
		 <a href="/ecommerce/controlador?acao=IndexFormulario"><img src="imagens/logo.png" alt="Logo" height="80" width="200px" ></a>
	...
	<div class="dropdown d-flex align-items-center">
		...
		<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
			<li><a class="dropdown-item" href="/ecommerce/controlador?acao=LoginFormulario">Entrar</a></li>
			<li><a class="dropdown-item" href="/ecommerce/controlador?acao=CadastraClienteFormulario">Cadastro</a></li>
			<li><a class="dropdown-item" href="/ecommerce/controlador?acao=ListaClientes">Minha conta</a></li>
